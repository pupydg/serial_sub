...
bool self_interfaces__msg__speed_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("self_interfaces.msg._speed_control.SpeedControl", full_classname_dest, 47) == 0);
  }
  self_interfaces__msg__SpeedControl * ros_message = _ros_message;
  {  // left
...
PyObject * self_interfaces__msg__speed_control__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("self_interfaces.msg._speed_control");
