...
#include "speed_control/msg/detail/speed_control__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = speed_control::msg::SpeedControl;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const speed_control::msg::SpeedControl *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<speed_control::msg::SpeedControl *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_speed_control
const rosidl_message_type_support_t *
get_message_type_support_handle<speed_control::msg::SpeedControl>()
{
  return &speed_control::msg::typesupport_fastrtps_cpp::_SpeedControl__handle;
}
