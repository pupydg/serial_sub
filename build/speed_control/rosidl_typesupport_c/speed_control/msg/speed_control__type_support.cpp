...
static const _SpeedControl_type_support_symbol_names_t _SpeedControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, speed_control, msg, SpeedControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, speed_control, msg, SpeedControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, speed_control, msg, SpeedControl)() {
  return &::speed_control::msg::rosidl_typesupport_c::SpeedControl_message_type_support_handle;
}
