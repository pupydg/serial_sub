...
static const _SpeedControl_type_support_symbol_names_t _SpeedControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, self_interfaces, msg, SpeedControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, self_interfaces, msg, SpeedControl)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, self_interfaces, msg, SpeedControl)() {
  return &::self_interfaces::msg::rosidl_typesupport_c::SpeedControl_message_type_support_handle;
}
