...
static const _SpeedControl_type_support_symbol_names_t _SpeedControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, self_interfaces, msg, SpeedControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, self_interfaces, msg, SpeedControl)),
  }
};
...
{
  return &::self_interfaces::msg::rosidl_typesupport_cpp::SpeedControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, self_interfaces, msg, SpeedControl)() {
  return get_message_type_support_handle<self_interfaces::msg::SpeedControl>();
}
