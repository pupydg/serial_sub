...
#include "speed_control/msg/detail/speed_control__rosidl_typesupport_fastrtps_c.h"
...
#include "speed_control/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _SpeedControl__ros_msg_type = speed_control__msg__SpeedControl;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_speed_control
size_t get_serialized_size_speed_control__msg__SpeedControl(
  const void * untyped_ros_message,
...
static uint32_t _SpeedControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_speed_control__msg__SpeedControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_speed_control
size_t max_serialized_size_speed_control__msg__SpeedControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = speed_control__msg__SpeedControl;
    is_plain =
      (
...
static size_t _SpeedControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_speed_control__msg__SpeedControl(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, speed_control, msg, SpeedControl)() {
