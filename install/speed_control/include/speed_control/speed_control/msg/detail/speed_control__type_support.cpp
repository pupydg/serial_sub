...
{
  new (message_memory) speed_control::msg::SpeedControl(_init);
}

void SpeedControl_fini_function(void * message_memory)
{
  auto typed_message = static_cast<speed_control::msg::SpeedControl *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SpeedControl_message_member_array[2] = {
  {
    ...
    offsetof(speed_control::msg::SpeedControl, left),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(speed_control::msg::SpeedControl, right),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SpeedControl_message_members = {
  "speed_control::msg",  // message namespace
  "SpeedControl",  // message name
  2,  // number of fields
  sizeof(speed_control::msg::SpeedControl),
...
{
  return &::speed_control::msg::rosidl_typesupport_introspection_cpp::SpeedControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, speed_control, msg, SpeedControl)() {
  return &::speed_control::msg::rosidl_typesupport_introspection_cpp::SpeedControl_message_type_support_handle;
}
